...
from Predict.utils import get_model, load_model
...
MODELS_TO_USE = {
    'alexnet': {
        'weights_path': os.path.join(BASE_DIR, 'alexnet_weights_best_acc.tar'),
        'crop_size': 224,
        'resize_size': 256,
    },
    'vgg11': {
        'weights_path': os.path.join(BASE_DIR, 'vgg11_weights_best_acc.tar'),
        'crop_size': 224,
        'resize_size': 256,
    },
    'efficientnet_b4': {
        'weights_path': os.path.join(BASE_DIR, 'efficientnet_b4_weights_best_acc.tar'),
        'crop_size': 224,
        'resize_size': 256,
    },
    'inception_resnet_v2': {
        'weights_path': os.path.join(BASE_DIR, 'inception_resnet_v2_weights_best_acc.tar'),
        'crop_size': 299,
        'resize_size': 342,
    }
}
...
CLASS_IDX_TO_SPECIES_ID_PATH = os.path.join(BASE_DIR, 'class_idx_to_species_id.json')
SPECIES_ID_TO_NAME_PATH = os.path.join(BASE_DIR, 'plantnet300K_species_id_2_name.json')
